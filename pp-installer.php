...
Description: Theme installer plugin for ProPhoto version 6. Checks server compabitiliy, auto-registers, and allows test-driving P6 while safely keeping another theme active.
Author: ProPhoto
Version: 6.0.0
