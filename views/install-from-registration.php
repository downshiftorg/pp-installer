...
<h3>Install ProPhoto 7</h3>

<p id="install-from-registration-note" class="narrow">
    This plugin includes your unique registration authorization, so you're all set to download P7 and get started.  If you're ready to install P7, click below:
</p>

<a class="button button-primary button-hero" id="install-from-registration">
    Install ProPhoto 7
</a>
