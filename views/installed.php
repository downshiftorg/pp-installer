...
<p class="ppi-intro narrow">
    Your site is completely compatible with P8, and the theme is installed and ready
    to use. You can now choose to make P8 your active theme, or test-drive it while
...
<h3>Test-driving P8</h3>

<p class="narrow">
    If you choose to test-drive ProPhoto 8, only logged-in admin users will have P8
    as their active theme.  All other users will see your active theme:
    <b><?php echo p8i_get_non_test_drive_theme_name(); ?></b>. This allows you to work on your
    conversion to P8 and your updated responsive design in privacy, until you're ready
